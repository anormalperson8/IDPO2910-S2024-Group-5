...
You will be using Python 3. Why? \pause Because Python 1 are 2 are too old.
\onslide<1-2>
\begin{center}
...
\hspace{0.2\textwidth}\scalebox{0.5}{
\begin{tikzpicture}
...
% \begin{minted}[tabsize=4, xleftmargin=1em, linenos]{py}
