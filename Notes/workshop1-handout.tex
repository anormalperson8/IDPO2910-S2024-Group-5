...
\author[Game Programming using Python]{Additional Content for Workshop 1}
...
\node (func) [block, fill = DarkSeaGreen2] at ($(program) + (0, -\y1)$) {Functions};
...
This is a \textit{very} brief peek into functions.
\end{center}
