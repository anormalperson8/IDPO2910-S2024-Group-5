...
\setbeamertemplate{page number in head/foot}{\insertframenumber /46}
...
f = a / b   |\pause|# f stores the number 8.333333333333334
\end{minted}
\end{frame}
...
\begin{minted}[tabsize=4, escapeinside=||]{python}
a = 10 # a stores the integer 10
if not a == 0 or a == 1: # Same as a % 2 == 0 or a == 1
    print("a is 0 or 1")
else:
...
\setbeamertemplate{page number in head/foot}{S-\insertframenumber /S-33}
